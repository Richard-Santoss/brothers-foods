...
public class AutenticacaoActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty()){
                    if (!senha.isEmpty()){
                            ...
                            autenticacao.createUserWithEmailAndPassword(email, senha).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(AutenticacaoActivity.this,"Erro: " + erroExcecao, Toast.LENGTH_SHORT);
                                    }
                                }
                            });
                        } else {//Login
                        ...
                        Toast.makeText(AutenticacaoActivity.this,"Preencha a senha!", Toast.LENGTH_SHORT);
                    }

                } else {
                    Toast.makeText(AutenticacaoActivity.this,"Preencha o E-mail!", Toast.LENGTH_SHORT);
                }
    ...
    private void inicializaComponentes (){
        ...
        linerTipoUsuario = findViewById(R.id.linearTipoUsuario);
    }
}
